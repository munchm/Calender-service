...
//           <p>{open ? months[month] + ' ' + days : months[month] + ' ' + days}</p>
//         </div>
//       </Header>
...
//           <Border>
//             <Header>
//               <button type="button" onClick={() => setDate(new Date(year, month - 1, days))}> Previous Month </button>
//               <div>
//                 {months[month]}
//                 {' ' + year}
//               </div>
//               <button type="button" onClick={() => setDate(new Date(year, month + 1, days))}> Next Month </button>
